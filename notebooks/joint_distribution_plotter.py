...
def scatter_hist(x, y, ax, ax_histx, ax_histy):
    ...
    Args:
        ...
        y: array-like, shape (n, ) input data.
        ax: matplotlib.axes.Axes object to draw the ellipse into.
        ax_histx: matplotlib.axes.Axes object to draw the ellipse into.
        ax_histy: matplotlib.axes.Axes object to draw the ellipse into.
...
def plot_joint_distribution(x, y, title):
    ...
    confidence_ellipse(x, y, ax, edgecolor="black")
